...
function ZmanimCard() {
  ...
  // ✅ Format ISO time using LOCATION timezone (not user timezone)
        ...
        <>
          ...
          <table>
            <tbody>
              ...
              <tr><td><strong>Nightfall (Tzeit)</strong></td><td><strong>{formatTime(zmanim.times.tzeit, zmanim.location.timezone)}</strong></td></tr>
            </tbody>
          </table>
        </>
      )}
